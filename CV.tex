...
\cventry{Jan 2017}{DDFactorization}{``Improving Transcript Abundance Estimation Using Eq. Class Factorization (A Data Driven Approach)''}{Computational Biology Lab., SBU}{\newline{}\url{https://github.com/COMBINE-lab/salmon/tree/factorizations}}{We design a new efficient and accurate factorization of likelihoods across equivalence classes of read fragments in \href{https://github.com/COMBINE-lab/salmon}{Salmon}, a transcript-level quantification estimation tool. Using the new model, the estimation accuracy improves significantly without hurting the run time.}
\cventry{Nov. 2016 - Present}{Grouper}{An extension to ``Rapid Clustering'' tool}{Computational Biology Lab., SBU}{\newline{} \url{https://github.com/COMBINE-lab/grouper}}{Grouper, the extension of RapClust, is a tool for clustering contigs of a de novo transcriptome assembly. We improved the accuracy of clustering by making use of orphan reads, for which each end of the pair is mapped to a different reference sequence.}
